...
export class OrderList extends Component {
    ...
    ReviewModalOpen = (product_id, product_name) => {
        this.setState({ ReviewModal: true, product_id: product_id, product_name: product_name })
    };
        ...
        const MyView = MyList.map((ProductList, i) => {
            return <div>
                <Col md={6} lg={6} sm={6} xs={6}>
                    ...
                    <p>{ProductList.size} | {ProductList.color} | {ProductList.product_id}</p>
                    <h6>Price = {ProductList.unit_price} x {ProductList.quantity} = {ProductList.total_price}$</h6>
                    <h6>Stauts = {ProductList.order_status} </h6>

                </Col>
                <Button onClick={this.ReviewModalOpen.bind(this, ProductList.product_id, ProductList.product_name)} className="btn btn-danger">Post Review </Button>
                <hr></hr>
            </div>
        });
