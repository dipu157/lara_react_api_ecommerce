...
class ProductListController extends Controller
{
    ...
    public function StoreProduct(Request $request){
        ...
        $save_url = 'http://localhost:8000/upload/product/'.$name_gen;
    ...
    $save_url1 = 'http://localhost:8000/upload/productdetails/'.$name_gen1;


    $image2 = $request->file('image_two');
    $name_gen2 = hexdec(uniqid()).'.'.$image2->getClientOriginalExtension();
    Image::make($image2)->resize(711,960)->save('upload/productdetails/'.$name_gen2);
    $save_url2 = 'http://localhost:8000/upload/productdetails/'.$name_gen2;
    ...
    $save_url3 = 'http://localhost:8000/upload/productdetails/'.$name_gen3;
    ...
    $save_url4 = 'http://localhost:8000/upload/productdetails/'.$name_gen4;
    ...
    //     ProductList::findOrFail($subcategory_id)->update([
